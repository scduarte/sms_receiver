  ...
  factory SmsReceiver() {
    if (_instance == null) {
      final EventChannel eventChannel = const EventChannel(
          "plugins.scduarte.com/recvSMS", const JSONMethodCodec());
  ...
  factory SmsSender() {
    if (_instance == null) {
      final MethodChannel methodChannel = const MethodChannel(
          "plugins.scduarte.com/sendSMS", const JSONMethodCodec());
      final EventChannel stateChannel = const EventChannel(
          "plugins.scduarte.com/statusSMS", const JSONMethodCodec());
...
class SmsQuery {
  ...
  factory SmsQuery() {
    if (_instance == null) {
      final MethodChannel methodChannel = const MethodChannel(
          "plugins.scduarte.com/querySMS", const JSONMethodCodec());
...
class SmsRemover {
  static const platform = const MethodChannel("scduarte.sms.remove.channel");
...
class SimCardsProvider {
  ...
  factory SimCardsProvider() {
    if (_instance == null) {
      final MethodChannel methodChannel = const MethodChannel(
          "plugins.scduarte.com/simCards", const JSONMethodCodec());
